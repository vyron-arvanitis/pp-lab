...
This model extends the Deep Set architecture by introducing an eight dimensional PDG code for each particle,
...
by introducing a normalization of the inputs according to section \ref{sec:Nomralize features}. The architecture is the same as in the case of \ref{model:CombinedModel_wGCN}
