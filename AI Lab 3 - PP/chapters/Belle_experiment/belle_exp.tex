...
These facilities operate with a center-of-mass energy tuned 
to the \emph{$\Upsilon(4S)$ resonance}, 
a state that decays almost exclusively 
into pairs of $B$ and $\bar{B}$ mesons. 
This selective production mechanism enables detailed studies 
...
are elementary particles with no internal structure, which offers 
...
complex hadronic activity such as jets. Moreover, the absence of 
...
These subdetectors are designed to detect and identify 
the various particles produced in the collisions. 
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\linewidth]{chapters/Belle_experiment/Overview_collider}
