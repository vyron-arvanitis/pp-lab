...
\emph{corresponding to a value of $\sqrt{s} = 10.58$~GeV}. 
...
produced $B$ (and $\bar{B}$) mesons to travel measurable distances
...
on an independent test set and calculate the speedup (see sec \ref{sec:Speedup}) offered by each network.
