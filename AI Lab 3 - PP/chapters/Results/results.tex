...
validation loss of $0.430$ with a accuracy of $80.1\%$, it was identified as the best-performing model.
...
on computational efficiency. To address this, we also evaluate the speedup—(\ref{sec:Speedup})
...
From figure \ref{fig:ROC_curves_results}, we observe that the
...
\begin{table}[h]
    ...
    \begin{tabular}{l|c|c|c|c|c}
        ...
        DS\_combined\_wgcn\_normalized & $0.467$ & $77.6$ & $0.860$ & $5.373$ & $1.719$ \\
