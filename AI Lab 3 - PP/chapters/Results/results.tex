...
Comparing the different models yields following conclusions: Using the PDG numbers on the 
\begin{table}[h]
    \centering
    ...
    \begin{tabular}{lcc}
    \hline
    \textbf{Model} & \textbf{Validation Loss} & \textbf{Validation Accuracy} / (\%) \\
    \hline
...
Section \ref{sec:methodology} aims to find the optimal regularization, feature processing, and model architecture.
With all the finding, we merged everything into one model, expecting this to be the optimal model:
\begin{table}[h]
