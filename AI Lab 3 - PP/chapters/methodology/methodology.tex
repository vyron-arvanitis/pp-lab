...
more compact format using cylindrical coordinates, while discarding unnecessary information by neglecting the angular coordinate. To
test this hypothesis, the models \texttt{deepset}, \texttt{deepset\_gcn}, and \texttt{deepset\_combined} were trained with cartesian and cylindrical coordinates.
Training was done on all four row groups of the training set, 

\begin{table}[h]
    \caption{Validation metrics on cartesian vs cylindrical coordinates}
    \label{tab:deepset_gcn_variable_arc}
    \centering
    \begin{tabular}{l|cc|cc}
        ...
        \hline
        \texttt{deepset}& $0.6294$ & $63.88~\%$ &$64.69~\%$& $0.6219$ \\
        \texttt{deepset\_gcn}&$0.6235$&$64.79~\%$&$66.21\%$&$0.6119$ \\
