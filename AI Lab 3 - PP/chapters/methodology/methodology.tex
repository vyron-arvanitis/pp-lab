...
\begin{itemize}
  ...
  \item \textbf{Modest performance.} Overlall, even after considering optimized parameters, dropout strategies or adding PDG ids features, performances plateau at only about $60\%$ accuracy, far below our best models.
\end{itemize}
...
\begin{figure}[h]
  ...
  \caption{t‐SNE projection of the PDG embeddings.  Six common species are highlighted to illustrate that particles and their antiparticles (e.g.\ \(\pi^\pm\), \(p/\bar p\)) are close to each other.}
  \label{fig:pdg_tsne}
\end{figure}
