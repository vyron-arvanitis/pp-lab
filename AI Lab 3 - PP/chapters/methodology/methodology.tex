...
\begin{table}[h]
    ...
    \begin{tabular}{l|cc|cc}
        \hline
        Model & \multicolumn{2}{c|}{Cartesian} & \multicolumn{2}{c}{Cylindrical} \\
        \hline 
...
Rather than a random search, Optuna uses a statistical method called the Tree-structured Parzen Estimator (TPE). TPE models the relationship between hyperparameters and the objective function (validation loss) and focuses on sampling hyperparameters that are more likely to perform well. This method helps guide the search toward promising areas in the hyperparameter space, improving both efficiency and accuracy.
