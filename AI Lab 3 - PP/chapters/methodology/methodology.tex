...
All models used in this study can be found in \texttt{saved_models/Layers_investigation}.
...
while the cylindrical coordinates were reduced to \texttt{"prodTime"}, \texttt{"r"}, \texttt{"z"}, \texttt{"energy"}, \texttt{"p_xy"}, and \texttt{"pz"}.
