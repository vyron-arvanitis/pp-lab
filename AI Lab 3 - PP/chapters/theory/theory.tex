...
MLP are universal function approximators: by stacking several layers one can approximate arbitrarily complex mappings from its fixed‐length input vector to the desired output.
